...
def test_default_config_kanban_block_not_dropped_by_duplicate_key():
    ...
    # Liveness-ignore knobs (gh-78) must be present with safe defaults.
    assert kanban.get("decompose_ignore_liveness") is False
    assert kanban.get("decompose_ignore_liveness_base_urls") == []
